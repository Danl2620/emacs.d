...
(defun color-theme-danl ()
  "Color theme by danl, created 2008-09-09."
  (interactive)
  (color-theme-install
   '(color-theme-danl
     ((background-color . "#102e4e")
     ...
     (default ((t (:stipple nil :background "#102e4e" :foreground "#eeeeee" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 96 :width normal :family "outline-courier new"))))
     (Info-title-1-face ((t (:bold t :weight bold :height 1.728 :family "helv"))))
     (Info-title-2-face ((t (:bold t :weight bold :height 1.44 :family "helv"))))
     (Info-title-3-face ((t (:bold t :weight bold :height 1.2 :family "helv"))))
     (Info-title-4-face ((t (:bold t :weight bold :family "helv"))))
     ...
     (calendar-today-face ((t (:background "blue"))))
     (change-log-acknowledgement ((t (:italic t :foreground "CadetBlue" :slant italic))))
     ...
     (change-log-file ((t (:bold t :foreground "goldenrod" :weight bold))))
     (change-log-function ((t (:foreground "SeaGreen2"))))
     (change-log-list ((t (:bold t :foreground "DeepSkyBlue1" :weight bold))))
     (change-log-name ((t (:foreground "gold"))))
     (comint-highlight-input ((t (:bold t :weight bold))))
     (comint-highlight-prompt ((t (:foreground "cyan"))))
     (completions-common-part ((t (:family "outline-courier new" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#eeeeee" :background "#102e4e" :stipple nil :height 96))))
     (completions-first-difference ((t (:bold t :weight bold))))
     ...
     (dired-flagged ((t (:foreground "yellow"))))
     ...
     (dired-warning ((t (:italic t :slant italic :foreground "CadetBlue"))))
     ...
     (font-lock-m4-face ((t (:foreground "Khaki"))))
     ...
     (git-mark-face ((t (:bold t :foreground "red" :weight bold))))
     ...
     (info-node ((t (:foreground "DeepSkyBlue1"))))
     (info-xref ((t (:bold t :foreground "SeaGreen2" :weight bold))))
     (isearch ((t (:background "white" :foreground "brown4"))))
     (isearch-lazy-highlight-face ((t (:background "paleturquoise4"))))
     (isearch-secondary ((t (:background "paleturquoise" :foreground "Black"))))
     (italic ((t (:italic t :slant italic))))
     ...
     (show-paren-match ((t (:background "ForestGreen"))))
